  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
          ...
          <div class="container-fluid">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Pannes Essorage </h5>
              <div class="card">
                <div class="card-body">
...
<?php
            ...
            $sql = "SELECT dispo FROM essorage where  etat = 'en cours'";
          ...
          <select  class="form-select" name ="sub"  required>
            ...
            // Construct and execute a SQL query to fetch "dispos"
            $sql = "SELECT sub FROM essorage where dispo= '$dispo' AND etat = 'en cours'";
            $result = $conn->query($sql);
          ...
          <select  class="form-select" required name="machine" type="text">
            ...
            // Construct and execute a SQL query to fetch "dispos"
            $sql = "SELECT machine FROM essorage where dispo= '$dispo' AND sub= '$sub' AND etat = 'en cours'";
            $result = $conn->query($sql);
