...
if (isset($_POST['Submit'])) {
    ...
    if (mysqli_num_rows($result) >= 1) {
        $message = "Article D\u00e9ja existe !!!";
    } else {
        $insertQuery = "INSERT INTO `ref` (article) VALUES ('$article')";
...
$jsCode = "";
if (!empty($message)) {
    $jsCode = "<script>alert(\"$message\"); window.location.replace('ajouter-article.php');</script>";
}
?>
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <input type="text" class="form-control m-3" name="article" placeholder="Saisie Code Article" >
            <div class="m-3">
