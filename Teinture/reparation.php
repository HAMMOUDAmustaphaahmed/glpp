...
<li class="sidebar-item">
              <a class="sidebar-link" href="reparation.php" aria-expanded="true">
                <span>
                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body p-4">
                                    <h5 class="card-title fw-semibold mb-4">R&eacute;paration Teinture</h5>
                                        ...
                                        <table class="table text-nowrap mb-0 align-middle table-lg">
                                            <thead class="text-dark fs-4">
                                                <tr>
													...
													<th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">Date Blocage</h6>
                                                    </th>
                                                    <th class="border-bottom-0">
...
// Première requête
$query1 = "SELECT p.id AS preparation_id, p.article, p.couleur, s.dispo, s.sub, s.etat, s.date_blocage
          FROM `blocage` s
          LEFT JOIN `preparation` p ON s.dispo = p.dispo
		 
          WHERE (s.date_blocage >= DATE_SUB(NOW(), INTERVAL 24 HOUR))
          AND s.date_blocage != '0000-00-00 00:00:00'";
...
while ($row = mysqli_fetch_assoc($result1)) {
    ...
    echo "<td class='border-bottom-0'>" . $row['date_blocage'] . "</td>";
    echo "<td class='border-bottom-0'>";
    echo "<a href='edit-reparation.php?id=" . $row['preparation_id'] . "'><i class='ti ti-pencil'></i></a>"; // Icône d'édition
    echo "</td>";
