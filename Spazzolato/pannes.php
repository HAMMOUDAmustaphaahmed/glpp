  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
          ...
          <div class="container-fluid">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Pannes Spazzolato </h5>
              <div class="card">
                <div class="card-body">
...
<?php
            ...
            $sql = "SELECT dispo FROM spazzolato WHERE etat = 'en cours'";
          ...
          <select  class="form-select" name ="sub"  required>
            ...
            // Construct and execute a SQL query to fetch "dispos"
            $sql = "SELECT sub FROM spazzolato where dispo= $dispo";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<option value=''>No sub found</option>";
            }
