...
if (isset($_POST['fin'])) {
if ($deltae2 != "0.00"  ){
           if ( $etat == "en cours reparation"   ) {
			   
			   if ( $deltae3 == "0.00"   ) {
				   $etat1 = "fin reparation";
                    $updateQuery = "UPDATE `Teinture` 
                                        SET  deltaE = '$deltae2', etat = '$etat1', date_fin_Teinture ='$date_fin_teinture'
                                        WHERE dispo = '$dispo' AND etape = '$etape'";
	
					} else {
						$etat1 = "fin reparation";
                            $updateQuery = "UPDATE `Teinture` 
                                        SET  deltaE = '$deltae3', etat = '$etat1', date_fin_Teinture ='$date_fin_teinture'
                                        WHERE dispo = '$dispo' AND etape = '$etape'";
                        }
