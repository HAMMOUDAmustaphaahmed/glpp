...
<?php
        ...
        // Construct and execute a SQL query to fetch "dispos" from sechoire1
        $sql1 = "SELECT sub FROM teinture1 WHERE  dispo ='$dispo' AND etat = 'en cours'";
        $result1 = $conn->query($sql1);
        ...
        // Construct and execute a SQL query to fetch "dispos" from sechoire2
        $sql2 = "SELECT  sub FROM teinture2 WHERE dispo ='$dispo' AND etat = 'en cours'";
        $result2 = $conn->query($sql2);
        ...
        // Construct and execute a SQL query to fetch "dispos" from sechoire1
        $sql1 = "SELECT machine FROM teinture1 WHERE  dispo ='$dispo' AND etat = 'en cours'";
        $result1 = $conn->query($sql1);
        ...
        // Construct and execute a SQL query to fetch "dispos" from sechoire2
        $sql2 = "SELECT  machine FROM teinture2 WHERE dispo ='$dispo' AND etat = 'en cours' ";
        $result2 = $conn->query($sql2);
