...
<option>68-G</option>
      ...
      <input type="Nombre" class="form-control" name="nb_chariots" placeholder="Saisie Nombre Chariots">
    </div>
	    <div class="col">
      <label  class="form-label">Poids Apr&eacute;s Sfaldina</label>
      <input type="Nombre" class="form-control" name="poids_sfaldina" placeholder="Saisie poids">
    </div>
	</div>
	    <div id="form-data">
