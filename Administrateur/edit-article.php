...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT  `article` FROM `ref` WHERE `id` = ?";
...
if (isset($_POST['Submit'])) {
    ...
    // Update query
    $updateQuery = "UPDATE `ref` SET `article` = ? WHERE `id` = ?";
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <input type="text" class="form-control m-3" name="article"  value="<?php echo $article ?>">
            <div class="m-3">
