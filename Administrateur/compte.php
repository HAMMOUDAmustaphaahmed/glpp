                        ...
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body p-4">
                                    <h5 class="card-title fw-semibold mb-4">Liste Des Comptes</h5>
                                        ...
                                        <table class="table text-nowrap mb-0 align-middle table-lg">
                                            <thead class="text-dark fs-4">
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">D&eacute;partement</h6>
                                                    </th>
                                                    <th class="border-bottom-0">
                                                    ...
                                                    <th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">Privil&egrave;ge</h6>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                $result = mysqli_query($conn, "SELECT * FROM `compte`"); // Retrieve data from the database

                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    echo "<tr>";
                                                    echo "<td class='border-bottom-0'>" . $row['nom'] . "</td>";
                                                    echo "<td class='border-bottom-0'>" . $row['prenom'] . "</td>";
                                                    echo "<td class='border-bottom-0'>" . $row['departement'] . "</td>";
                                                    echo "<td class='border-bottom-0'>" . $row['matricule'] . "</td>";
                                                    echo "<td class='border-bottom-0'>" . $row['pwd'] . "</td>";
                                                    echo "<td class='border-bottom-0'>" . $row['prev'] . "</td>";
                                                    echo "</tr>";
                                                }
