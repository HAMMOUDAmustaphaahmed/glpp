...
$sub=$row['sub'];
    ...
    if (in_array($article, array('AOU', 'ATN', 'VR5', 'YN4'))) {
        if (!in_array($couleur, array('074', '101', '501', '506', '507'))) {
            $deleteQueries = array("preparation","sfaldina", "teinture", "essorage", "sechoire", "spazzolato", "teinture", "sechoire", "rameuse", "controle");
        } else {
        ...
        $deleteQueries = array("preparation","sfaldina", "teinture", "essorage", "sechoire", "rameuse", "controle");
    }
