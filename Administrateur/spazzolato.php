...
<head>
  ...
  <title>Pilotage spazzolato</title>
  ...
  <div class="card-body">
                        <div class="col-xl-12  d-flex ">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title fw-semibold mb-4">Pilotage Spazzolato</h5>
                  ...
                  <table id="myTable" class="table table-hover">
                                            ...
                                            <thead class="text-dark fs-4">
												...
												<th class="border-bottom-0">
													...
													<th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">Date Debut Spazzolato</h6>
                                                    </th>
													
													<th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">Date Fin Spazzolato</h6>
                                                    </th>
                                                    <th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">Dur&eacute;e Spazzolato</h6>
                                                    </th>
...
$query = "SELECT  s.dispo,
 ...
 ORDER BY s.date_debut_spazzolato DESC";
...
while ($row = mysqli_fetch_assoc($result)) {
  ...
  $date_actuelle = date('Y-m-d H:i:s', strtotime('+1 hour'));
    ...
    $duree_spazzolato = strtotime($date_fin_spazzolato) - strtotime($date_debut_spazzolato);
...
if ($date_fin_spazzolato != "0000-00-00 00:00:00"){
...
document.getElementById("exportButton").addEventListener("click", function() {
    ...
    var url = `extraction-spazzolato.php?filterInput=${filterInput}&filterColor=${filterColor}&filterArticle=${filterArticle}&filterEtat=${filterEtat}&Date=${Date}&startDate=${startDate}&endDate=${endDate}`;
...
function filterTableDispo() {
    ...
    for (i = 0; i < tr.length; i++) {
        td1 = tr[i].getElementsByTagName("td")[1]; // Index 2 correspond à la colonne "Nom"
        td2 = tr[i].getElementsByTagName("td")[4]; // Index 5 correspond à la colonne "Couleur"
        td3 = tr[i].getElementsByTagName("td")[3]; // Index 4 correspond à la colonne "Article"
		td4 = tr[i].getElementsByTagName("td")[5]; // Index 1 correspond à la colonne "Etat"
